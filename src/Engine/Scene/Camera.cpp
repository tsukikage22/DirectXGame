...
XMFLOAT4X4 Camera::GetViewMatrix()
{
    ...
    viewMatrix.r[3]     = XMVectorSetW(-XMVector3Transform(posVec, viewMatrix), 1.0f);
...
{
    DirectX::XMMATRIX projMatrix = DirectX::XMMatrixPerspectiveFovLH(m_fovYRad, m_aspect, m_nearZ, m_farZ);
...
// カメラの視錐台を覆う球を計算する
DirectX::BoundingSphere Camera::ComputeBoundingSphere(float nearZ, float farZ) const
{

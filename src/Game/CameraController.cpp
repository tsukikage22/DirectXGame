...
CameraController::CameraController()
    : m_pCamera(nullptr), m_pInputSystem(nullptr), m_moveSpeed(3.0f), m_sensitivity(0.2f), m_pitch(0.0f), m_yaw(0.0f)
{
}
...
DirectX::XMFLOAT2 CameraController::ForwardToEuler(const DirectX::XMFLOAT3& forward)
{

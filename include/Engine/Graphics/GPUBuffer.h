...
public:
    ...
    bool CreateStatic(ID3D12Device* pDevice, ID3D12GraphicsCommandList* pCmdList, size_t size, const void* pInitData,
        D3D12_RESOURCE_STATES finalState);

    /// @brief VBやIBなどの静的バッファを作成する，ResourceUploadBatch使用
    bool CreateStatic(ID3D12Device* pDevice, DirectX::ResourceUploadBatch& batch, size_t count, size_t stride,

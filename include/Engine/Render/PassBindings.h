...
struct ScenePassBindings
{
    ...
    bool IsValid() const
    {
        return pCmdList != nullptr && pCbvSrvUavHeap != nullptr && sceneCB != 0 && displayCB != 0 && iesSRV.ptr != 0 &&
               lightSRV.ptr != 0 && irradianceSRV.ptr != 0 && prefilteredSRV.ptr != 0 && brdfLutSRV.ptr != 0 &&
               shadowMapSRV.ptr != 0;
    }
};
...
struct CompositePassBindings
{
    ...
    bool IsValid() const
    {
        return pCmdList != nullptr && pCbvSrvUavHeap != nullptr && displayCB != 0 && uiSRV.ptr != 0;
    }
};
...
struct SkyboxPassBindings
{
    ...
    bool IsValid() const
    {
        return pCmdList != nullptr && pCbvSrvUavHeap != nullptr && sceneCB != 0 && displayCB != 0 && skyboxSRV.ptr != 0;
    }
};
...
struct ShadowPassBindings
{
    ...
    bool IsValid() const
    {
        return pCmdList != nullptr && sceneCB != 0;
    }
};

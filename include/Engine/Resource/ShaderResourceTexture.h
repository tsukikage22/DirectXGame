...
public:
    ...
    ShaderResourceTexture& operator=(ShaderResourceTexture&&) noexcept = default;
    ...
    bool InitSolidColorRGBA8(ID3D12Device* pDevice, DescriptorPool* pPoolSRV, uint8_t r, uint8_t g, uint8_t b,
        uint8_t a, DirectX::ResourceUploadBatch& batch);
